...
const Home = () => {
  ...
  return (
    ...
    <div name='home' className='w-full h-screen bg-[#08192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full align-items sm:mt-10 sm:pt-10'>

            <p className='text-yellow-700'> Hi, my name is </p>

            <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6]'> Landry </h1>
